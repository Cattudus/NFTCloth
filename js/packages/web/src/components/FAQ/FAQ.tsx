    ...
    <LayoutContent>
      <div style={{paddingTop: '30px'}} id="FAQ">
        ...
        <Collapse>
          ...
          <Panel
            style={{fontSize: '18px'}}
            header="What are HOODIE drops?"
            key="2"
          >
            <p style={{fontSize: '15px', color: 'white'}}>
              If you are Specter NFT holder you have a chance to drop special and limited clothes. You can make sure
              that every piece of clothing is unique. There will be free and also paid drops. The drops are bound to
              NFT. So you can sell NFT with hoodie drop.
            </p>
          </Panel>
          <Panel
            style={{fontSize: '18px'}}
